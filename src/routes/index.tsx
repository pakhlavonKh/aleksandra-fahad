    ...
    <section className="py-32 px-6 max-w-4xl mx-auto">
      ...
      <div className="reveal mt-16 bg-card border hairline border-border p-10 md:p-16 text-center">
        ...
        <p className="font-mono text-[11px] tracking-[0.2em] text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          По приглашению вы уже поняли: у нас две главные страсти — друг к другу и дешёвые
          авиабилеты. ✈️ Поэтому лучшим подарком будет вклад в наш honeymoon fund. Обещаем потратить
          его максимально романтично и местами безответственно. 🌍
        </p>
      </div>
    </section>
  );
